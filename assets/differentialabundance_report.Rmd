...
if (length(blocking_variables) > 0) {
    ...
    for (block_var in blocking_variables) {
        ...
        cat(paste0("\n#### Corrected for: ", block_var, " {.tabset}\n"))
        ...
        cat("\n##### PCA-metadata associations (batch-corrected)\n")
        cat(paste0("\nANOVA test results for associations between principal components (after ", block_var, " correction) and metadata variables.\n\n"))
